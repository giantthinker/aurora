...
<html lang="en">
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     @meta('image', 'https://res.cloudinary.com/ddxmmbrih/image/upload/w_1000,c_fill,ar_1:1,g_auto,r_max,bo_5px_solid_red,b_rgb:262c35/v1553464114/7ihosting_server1.jpg')
     {!! Meta::tag('keywords') !!}
     
     <title>{!! Meta::get('site_name') !!} {!! Meta::get('title') !!}</title>
