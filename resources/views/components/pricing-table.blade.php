      ...
      <div class="row">   
        <div class="col-sm-12 col-md-4 col-lg-4">
          <div class="wrapper text-left">
            <div class="plans badge feat bg-pink">service populaire</div>
        ...
        <div class="col-sm-12 col-md-4 col-lg-4">
          <div class="wrapper third text-left">
            <div class="top-content">
              ...
              <div class="title">VPS Cloud </div>
              <div class="fromer">À partir de:</div>
              <div class="price">8,000<sup>FCFA</sup> <span class="period">/mois</span></div>
              <a href="#" class="btn btn-default-yellow-fill">Les Forfaits</a>
            </div>
            <ul class="list-info">
